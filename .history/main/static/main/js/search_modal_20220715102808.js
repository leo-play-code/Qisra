...
var search_target_activate = document.querySelectorAll('.search_target_activate')
...
function _reset_search_table(value){
    if (value == 'Project'){
        ...
        _show_ornot(search_target_activate,false)
        ...
        _show_ornot(search_target_activate,true)
...
function _Search_Main(){
    ...
    var search_all_activate = document.getElementById('search_all_activate').checked
    ...
    search_dict['creator'] = search_all_creator
    search_dict['activate'] = search_all_activate
...
function _Search_all_Testplan(search_dict){
    ...
    target_start_date=search_dict['start_date'] 
    target_end_date=search_dict['end_date'] 
    target_activate = search_dict['activate']
    ...
    search_all_testplan_tr.forEach(element => {
        ...
        var testplan_name = element.querySelector('#search_all_check_testplan_name').innerText
        ...
        var activate = element.querySelector('#search_all_testplan_activate').innerText
        var temp_tag_list = []
        tag_list_div.forEach(element =>{
            temp_tag_list.push(element.innerHTML)
        })
...
search_all_reset.addEventListener('click',function(e){
    ...
    document.getElementById('search_all_activate').checked = true
