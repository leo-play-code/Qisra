...
def Testplanview(request,pk):
    ...
    if 'save_info' in request.POST:
        ...
        testplan.save()
    print(testrun_dict)
    context = {'testplan':testplan,'tag_list':tag_list,'count':count,'test':testrun_dict}
...
def TestPlanView_test(request,pk):
    ...
    for instance in testcase_list:
        ...
        testcase_intestplan.append({'pk': instance.pk, 'name': instance.name,'datecreated':testcase_datetimem 'tag': tag_list})
