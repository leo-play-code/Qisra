...
def Testplanview(request,pk):
    ...
    for item in testrun:
        ...
        testrun_teststep_list = TeststepforTestplan.objects.filter(testcase = testrun)
    ...
    context = {'testplan':testplan,'tag_list':tag_list,'count':count,'testrun_dict':testrun_dict,
               }
