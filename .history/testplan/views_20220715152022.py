...
# 'save_info': ['save_info'], 'testcasename': ['newtestplan2123'], 'tag_list[]': ['new1', 'new2', '111'], 'context': ['<p>new tsetplan2 descriptionfasdfsdaf</p>\n'], 'stage': ['EVT0'], 'assign': ['leo'], 'start_date': ['2022-07-15'], 'end_date': ['2023-10-24'], 'activate': ['true']}>
...
def Testplanview(request,pk):
    ...
    context = {'testplan':testplan,'tag_list':tag_list}
