...
class TestPlan_test(models.Model):
    ...
    creator = models.ForeignKey(User , null= True , on_delete=models.SET_NULL,related_name='create_set_testplan' blank=)
    assign = models.ForeignKey(User , null= True , on_delete=models.SET_NULL,related_name='assign_set_testplan')
    def __str__(self):
        return self.name
