...
function _Testplan_search_testcase(){
    var testplan_search_testcase_name = $('#testplan_search_testcase_name').val()
    var testplan_search_testcase_tag = $('#testplan_search_testcase_tag').val()
    console.log(testplan_search_testcase_name,testplan_search_testcase_tag)
    console.log('search testplan ')
}
...
function _change_testcase_table(){
    console.log('change testcase table')
}