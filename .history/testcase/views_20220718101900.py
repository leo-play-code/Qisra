    ...
    if 'save_teststep' in request.POST:
        ...
        for item in teststep_dict:
            if teststep_dict[item][0] != '':
                debug_excel('before save',[count+1,teststep_dict[item][0],teststep_dict[item][1],teststep_dict[item][2]])
                ...
                debug_excel('after_save',[count+1,teststep_dict[item][0],teststep_dict[item][1],teststep_dict[item][2]])
                count+=1
        tag_object_list = testcase.tag.all()
