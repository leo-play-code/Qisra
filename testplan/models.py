...
class Testrun(models.Model):
    ...
    def __str__(self):
        if self.testplan == None:
            return self.testplans.testplan_group.issue_name+'-'+str(self.number)
        else:
            return self.testplan.issue_name+'-'+str(self.number)
...
class Testplan_count(models.Model):
    testplan = models.ForeignKey(
        Testplan, null=True, on_delete=models.SET_NULL ,blank=True)
    testplan_group = models.ForeignKey(
        Testplan_Group, null=True, on_delete=models.SET_NULL, blank=True)